...
public class DTimer extends JFrame implements ActionListener
{
	/****
	    ...
	    *
	    ****/
	public JLabel viewTime;  // composant permettant l'affichage du temps ecoule
	public int timeCount;	// variable permettant de memoriser le temps ecoule
	public Timer timer;		// objet javax.swing.Timer
